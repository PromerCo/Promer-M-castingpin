...
/**
 * This is the model class for table "castingpin_pull".
 *
 * @property integer $id
 ...
 */
class CastingpinPull extends \backend\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['actor_id', 'notice_id'], 'required'],
            [['actor_id', 'notice_id', 'bystander_frequency'], 'integer'],
            [['enroll_time', 'success_time', 'create_date', 'update_time'], 'safe'],
            [['ideas'], 'string', 'max' => 100],
            [['is_enroll', 'is_collect', 'is_success'], 'string', 'max' => 1],
            [['actor_id', 'notice_id'], 'unique', 'targetAttribute' => ['actor_id', 'notice_id']]
        ];
    }
