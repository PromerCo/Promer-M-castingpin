...
castingpin_notice.occupation,castingpin_notice.age,castingpin_notice.speciality,castingpin_notice.convene,castingpin_notice.profile,castingpin_notice.enroll,castingpin_notice.enroll_number,castingpin_notice.bystander_number,castingpin_notice.create_time,castingpin_notice.cast_id
FROM castingpin_notice 
LEFT JOIN castingpin_arranger ON castingpin_notice.arranger_id = castingpin_arranger.id
