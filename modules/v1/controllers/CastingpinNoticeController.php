...
class CastingpinNoticeController extends BaseController
{
    ...
    /**
     * Lists all CastingpinNotice models.
     * @return mixed
     */
    public function actionIndex()
    {
        $query = CastingpinNotice::find();
    ...
    /**
     * Displays a single CastingpinNotice model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CastingpinNotice model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new CastingpinNotice();
    ...
    /**
     * Updates an existing CastingpinNotice model.
    ...
    /**
     * Deletes an existing CastingpinNotice model.
    ...
    {
        if(count($ids) > 0){
            $c = CastingpinNotice::deleteAll(['in', 'id', $ids]);
    ...
    /**
     * Finds the CastingpinNotice model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CastingpinNotice the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CastingpinNotice::findOne($id)) !== null) {
            return $model;
        } else {
