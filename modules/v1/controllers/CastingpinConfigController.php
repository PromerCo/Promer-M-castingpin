 ...
 */
class CastingpinConfigController extends BaseController
{
	public $layout = "lte_main";

    /**
     * Lists all CastingpinConfig models.
     * @return mixed
     */
    public function actionIndex()
    {
        $query = CastingpinConfig::find();
    ...
    /**
     * Displays a single CastingpinConfig model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CastingpinConfig model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new CastingpinConfig();
    ...
    /**
     * Updates an existing CastingpinConfig model.
    ...
    /**
     * Deletes an existing CastingpinConfig model.
    ...
    {
        if(count($ids) > 0){
            $c = CastingpinConfig::deleteAll(['in', 'id', $ids]);
    ...
    /**
     * Finds the CastingpinConfig model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CastingpinConfig the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CastingpinConfig::findOne($id)) !== null) {
            return $model;
        } else {
