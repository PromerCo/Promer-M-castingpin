...
class CastingpinActorController extends BaseController
{
    ...
    /**
     * Lists all CastingpinActor models.
     * @return mixed
     */
    public function actionIndex()
    {
        $query = CastingpinActor::find();
    ...
    /**
     * Displays a single CastingpinActor model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CastingpinActor model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new CastingpinActor();
    ...
    /**
     * Updates an existing CastingpinActor model.
    ...
    /**
     * Deletes an existing CastingpinActor model.
    ...
    {
        if(count($ids) > 0){
            $c = CastingpinActor::deleteAll(['in', 'id', $ids]);
    ...
    /**
     * Finds the CastingpinActor model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CastingpinActor the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CastingpinActor::findOne($id)) !== null) {
            return $model;
        } else {
