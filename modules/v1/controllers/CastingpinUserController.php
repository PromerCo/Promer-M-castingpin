...
class CastingpinUserController extends BaseController
{
    ...
    /**
     * Lists all CastingpinUser models.
     * @return mixed
     */
    public function actionIndex()
    {
        $query = CastingpinUser::find();
    ...
    /**
     * Displays a single CastingpinUser model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CastingpinUser model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new CastingpinUser();
        if ($model->load(Yii::$app->request->post())) {
        
              if(empty($model->capacity) == true){
                  $model->capacity = 2;
              }
    ...
    /**
     * Updates an existing CastingpinUser model.
    ...
    /**
     * Deletes an existing CastingpinUser model.
    ...
    {
        if(count($ids) > 0){
            $c = CastingpinUser::deleteAll(['in', 'id', $ids]);
    ...
    /**
     * Finds the CastingpinUser model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CastingpinUser the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CastingpinUser::findOne($id)) !== null) {
            return $model;
        } else {
